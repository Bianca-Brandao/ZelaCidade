...
const criarBanco = async () => {
    ...
    if (checagem.total === 0) {
        await db.exec(`
        INSERT INTO incidentes(tipo_problema, localizacao, descricao, prioridade, nome_solicitante,
        data_registro, hora_registro) VALUES
        ('Iluminação', 'Rua das Flores, 123, Bairro das Margaridas', 'Poste queimado há dias', 'Média', 'Ana Clara', '16/03/2026', '10:30'),
        ('Falta de energia', 'Hospital JP2', 'Local na escuridão', 'Alta', 'Antônio Perna Quebrada', '16/03/2026', '22:15'),
        ('Vazamento de água', 'Rua das Camélias, 52', 'Vazamento de água constante próximo ao bueiro', 'Alta', 'Júlia Martins', '16/03/2026', '10:00'),
